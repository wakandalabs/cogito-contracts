...
var _bindata = map[string]func() (*asset, error){
	...
	"../../../transactions/scripts/read_totalSupply.cdc":       TransactionsScriptsGet_totalsupplyCdc,
			...
			"..": {nil, map[string]*bintree{
				"transactions": {nil, map[string]*bintree{
					...
					"scripts": {nil, map[string]*bintree{
						"read_totalSupply.cdc":       {TransactionsScriptsGet_totalsupplyCdc, map[string]*bintree{}},
